# Target file: tests/test_end_to_end_flight_booking_full_journey_across_pages.py
...
class ContentPage:
    ...
    def click_the_first_flight_s_select_flight_button(self, page: Page, test_data: dict) -> None:
...
def test_end_to_end_flight_booking_full_journey_across_pages(page: Page, vtest_base_url: str, test_data: dict) -> None:
    ...
    content_page.click_the_first_flight_s_select_flight_button(page, test_data)
